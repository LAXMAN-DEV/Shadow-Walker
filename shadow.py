...
dribbble, codecademy, gravatar, foursquare, roblox, gumroad, newsground,
...
bandcamp, colourlovers, ifttt, ebay, slack, okcupid, trip, ello, ]


def banner():
    red(r'''
  ________.__               .___               __      __       .__   __                 
 /   _____|  |__ _____    __| _/______  _  __ /  \    /  _____  |  | |  | __ ___________ 
 \_____  \|  |  \\__  \  / __ |/  _ \ \/ \/ / \   \/\/   \__  \ |  | |  |/ _/ __ \_  __ \
 /        |   Y  \/ __ \/ /_/ (  <_> \     /   \        / / __ \|  |_|    <\  ___/|  | \/
/_______  |___|  (____  \____ |\____/ \/\_/     \__/\  / (____  |____|__|_ \\___  |__|   
        \/     \/     \/     \/                      \/       \/          \/    \/       
  ''')
...
def search():
    yellow(f'Shadow Walker is monitoring.....\n')
    time.sleep(0.5)
    print('**********')
    time.sleep(0.5)
    print('**********')
    time.sleep(0.5)
    print('*************************************************************\n')
    green(f'Looking Up for Username:{username}\n')
    time.sleep(0.5)
    print('*************************************************************')
    time.sleep(0.5)
    print('**********')
